...
${OBJECTDIR}/Orbitals.o: nbproject/Makefile-${CND_CONF}.mk Orbitals.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Orbitals.o Orbitals.cpp

${OBJECTDIR}/Walker.o: nbproject/Makefile-${CND_CONF}.mk Walker.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Walker.o Walker.cpp
...
${OBJECTDIR}/QMC.o: nbproject/Makefile-${CND_CONF}.mk QMC.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/QMC.o QMC.cpp

${OBJECTDIR}/QMCmain.o: nbproject/Makefile-${CND_CONF}.mk QMCmain.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/QMCmain.o QMCmain.cpp
...
${OBJECTDIR}/DMC_old.o: nbproject/Makefile-${CND_CONF}.mk DMC_old.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/DMC_old.o DMC_old.cpp
...
${OBJECTDIR}/vmc_old.o: nbproject/Makefile-${CND_CONF}.mk vmc_old.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/vmc_old.o vmc_old.cpp
